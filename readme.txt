...
Define the Stimulus Directory in the experiment file as the correct language:
...
(3) Screen settings (Width, Height, and bit depth) should be entered in the RestingState.sce file: Lines 30-223
